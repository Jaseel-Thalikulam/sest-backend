...
function PartialType(classRef) {
    ...
    function applyFields(fields) {
        (0, mapped_types_utils_1.clonePluginMetadataFactory)(PartialTypeClass, classRef.prototype, (metadata) => (0, lodash_1.mapValues)(metadata, (item) => ({ ...item, required: false })));
        ...
        fields.forEach((key) => {
            ...
            const decoratorFactory = (0, decorators_1.ApiProperty)({
                ...metadata,
                required: false
            });
