...
let MeetService = exports.MeetService = class MeetService {
    constructor(createJitsiMeetToken) {
        this._createJitsiMeetToken = createJitsiMeetToken;
    }
    async generateToken(meetData) {
        return await this._createJitsiMeetToken.execute(meetData);
    }
};
exports.MeetService = MeetService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [createJitsiMeetToken_1.default])
], MeetService);
