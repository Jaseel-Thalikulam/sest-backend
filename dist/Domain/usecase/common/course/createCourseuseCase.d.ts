...
declare class createCourseUseCase {
    private readonly CourseRepository;
    constructor(courseRepository: mongooseCourseRepository);
    execute(createCourse: createCourseDTO): Promise<import("mongoose").Document<unknown, {}, import("../../../entity/course.entity").default> & import("../../../entity/course.entity").default & Required<{
